...
?>
    ...
    <div class="catalog_top">
        ...
        <div class="catalog_view">
            ...
            <a class="catalog_view_item list active" href="<?= $APPLICATION->GetCurPageParam("ch=3",array('ch'))?>"></a>
        </div>
        <div class="catalog_show">Товары: <?=$arResult['NAV_RESULT']->result->num_rows?> из <?= $arResult['NAV_RESULT']->NavRecordCount?></div>
        <?if($arParams["DISPLAY_BOTTOM_PAGER"]):?>
            <?=$arResult["NAV_STRING"]?>
        <?endif;?>
    </div>
<div class="catalog_list_displayList">
