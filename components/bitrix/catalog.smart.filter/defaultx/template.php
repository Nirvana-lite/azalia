...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?>">
        <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="bx-filter-section catalog_filter">
            ...
            <div class="row">
                <?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
                {
                    ...
                    if(isset($arItem["PRICE"])):
                        ...
                        else
                        {
                            ...
                            for ($i = 0; $i < $step_num; $i++)
                            {
                                $prices[$i] = number_format($arItem["VALUES"]["MIN"]["VALUE"] + $step*$i, 0, "", " ");
                            }
                            $prices[$step_num] = number_format($arItem["VALUES"]["MAX"]["VALUE"], 0, "", " ");
                        }
                        ?>
                        <div class="bx-filter-parameters-box bx-active">
                            <span class="bx-filter-container-modef"></span>
                            <div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><span><?=($arItem['NAME'] != 'Клиенты с сайта розница')?$arItem["NAME"]:'Цена'?> </span><i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i></div>
                                    ...
                                    <div class="bx-filter-parameters-box-container-block bx-left">
                                        <div class="bx-filter-input-container">
                                            <input
                                                    ...
                                                    value="<?echo ($arItem["VALUES"]["MIN"]["FILTERED_VALUE"])?$arItem["VALUES"]["MIN"]["FILTERED_VALUE"]:$arItem["VALUES"]["MIN"]["VALUE"] ?>"
                                                    size="5"
                                                    onkeyup="smartFilter.keyup(this)"
                                            />
                                        </div>
                                    </div>
                                    <span class="filter-price_box-minus">-</span>
                                    <div class="bx-filter-parameters-box-container-block bx-right">
                                        <div class="bx-filter-input-container">
                                            <input
                                                    ...
                                                    value="<?echo ($arItem["VALUES"]["MAX"]["FILTERED_VALUE"])?$arItem["VALUES"]["MAX"]["FILTERED_VALUE"]:$arItem["VALUES"]["MAX"]["VALUE"] ?>"
                                                    size="5"
                                                    onkeyup="smartFilter.keyup(this)"
                                            />
                                        </div>
                ...
                ?>
                        ...
                        <div class="bx-filter-parameters-box-container filter-clear">
                            <input
