...
?>
	...
	<form class="subscription_wrapper" id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
		<?=bitrix_sessid_post()?>
        <div class="subscription_text">Узнавайте одними из первых о наших выгодных предложениях и распродажах</div>
		<input type="hidden" name="sender_subscription" value="add">

        <div class="subscription_box">
            <input class="subscription_input" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
            <button class="subscription_request" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
        </div>
